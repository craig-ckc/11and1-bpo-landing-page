...
export function startLoader() {
    ...
    // }
    const svg = document.querySelector(".loader_logo svg");
    const paths = document.querySelectorAll(".loader_logo svg path");
    const bars = document.querySelectorAll(".loader_column");
    const headerSpans = document.querySelectorAll(".hero_heading > span");
    const footnotes = document.querySelectorAll(".hero_footnote");
    if (svg) {
